...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lí nhóm /</span> Thêm nhóm người dùng</h4>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mx-3">
                    ...
                    <a href="{{ route('dashboard.group.index') }}" class="btn btn-outline-primary btn-sm">Danh sách nhóm người dùng</a>
                </div>
                <hr class="my-0" />
                <!-- Account -->
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror " type="text"
                                    id="name" name="name" value="{{ old('name') }}" placeholder="Tên nhóm người dùng"
                                    autofocus />
                                @error('name')
