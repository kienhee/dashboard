...
[
'name' => 'Groups',
'classIcon' => 'menu-icon tf-icons bx bx-group',
...
'route' => '#',
'children' => [['name' => 'Account', 'route' => 'dashboard.templates.account-settings.account'], ['name' =>
'Notifications', 'route' => 'dashboard.templates.account-settings.notifications'], ['name' => 'Connections', 'route' =>
'dashboard.templates.account-settings.connections']],
],
[
'name' => 'Authentications',
'classIcon' => 'menu-icon tf-icons bx bx-lock-open-alt',
'route' => '#',
'children' => [['name' => 'Login', 'route' => 'dashboard.templates.auth.login'], ['name' => 'Register', 'route' =>
'dashboard.templates.auth.register'], ['name' => 'Forgot Password', 'route' =>
'dashboard.templates.auth.forgot-password']],
],
[
'name' => 'Misc',
'classIcon' => 'menu-icon tf-icons bx bx-cube-alt',
'route' => '#',
'children' => [['name' => 'Error', 'route' => 'dashboard.templates.misc.error'], ['name' => 'Under Maintenance', 'route'
=> 'dashboard.templates.misc.under-maintenance']],
],
[
'name' => 'User interface',
...
'route' => '#',
'children' => [['name' => 'Perfect scrollbar', 'route' => 'dashboard.templates.extended-ui.perfect-scrollbar'], ['name'
=> 'Text Divider', 'route' => 'dashboard.templates.extended-ui.text-divider']],
],
[
'name' => 'Form Elements',
'classIcon' => 'menu-icon tf-icons bx bx-detail',
'route' => '#',
'children' => [['name' => 'Basic Inputs', 'route' => 'dashboard.templates.form-elements.basic-inputs'], ['name' =>
'Input groups', 'route' => 'dashboard.templates.form-elements.input-groups']],
],
[
'name' => 'Form Layouts ',
'classIcon' => 'menu-icon tf-icons bx bx-detail',
'route' => '#',
'children' => [['name' => 'Vertical Form', 'route' => 'dashboard.templates.form-layouts.vertical'], ['name' =>
'Horizontal Form', 'route' => 'dashboard.templates.form-layouts.horizontal']],
],
[
'name' => 'Tables',
'classIcon' => 'menu-icon tf-icons bx bx-table',
