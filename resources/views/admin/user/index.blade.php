...
@section('title', $title)
@section('content')
<x-breadcrumb parentName="{{$title}}" parentLink="dashboard.user.index" childrenName="List" />
<div class="card">
    <x-alert />
    <x-header-table link="dashboard.user.add" linkName="New user" />
    <div class="card-body">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form class="dropdown-item"
                                        ...
                                        method="POST" @if ($item->trashed()) onsubmit="return confirm('Are you sure you
                                        want
