...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lý bảng màu /</span> Cập nhật</h4>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mx-3">
                    ...
                    <a href="{{ route('dashboard.size.index') }}" class="btn btn-outline-primary btn-sm">Danh sách màu
                    </a>
                </div>
                <hr class="my-0" />
                <!-- Account -->
