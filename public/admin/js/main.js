...
function checkChar(inputParam, outputParam) {
    let input = document.getElementById(inputParam).value;
    let quantityChar = document.getElementById(outputParam);
    if (input.length > 255) {
        quantityChar.style.color = "red";
    } else {
        quantityChar.style.color = "inherit";
    }
    quantityChar.innerText = input.length;
}
